...
const AIAdvisor = () => {
  const [messages, setMessages] = useState([
    {
      sender: 'ai',
      text: "Hello! I'm Finman AI, your personal financial advisor. I have access to your complete financial data — your income, expenses, savings, and goals.\n\nAsk me anything about your finances! 💡",
